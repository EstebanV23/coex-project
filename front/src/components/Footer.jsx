...
export default function Footer () {
  return (
    <div className='w-full h-fit flex flex-wrap 2xl:justify-around justify-start gap-10 p-7 font-light text-gray-500 text-base bg-black   bottom-0'>
      <div className='w-80 text-left'>
        ...
        <div className='my-5 w-[300px] h-[30px]'>
