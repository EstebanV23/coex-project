  ...
  return createPortal(
    <div className='w-screen h-screen fixed top-0 left-0 bg-black bg-opacity-50 z-50 flex items-center justify-center'>
      <div className='relative w-[500px] bg-white min-h-[100px] rounded-3xl shadow-xl p-5'>
        ...
        {children}
        <button onClick={() => open()} className='absolute right-5 top-5 hover:bg-gray-200 rounded-full px-2 py-1 ease-in-out duration-300'><AiOutlineClose size={20} fill='#264446' /></button>
      </div>
    </div>,
