...
export default function LinksProfile () {
  const defaultStyles = 'py-0 after:contens-[] text-base after:transition-all after:w-full after:opacity-0 after:h-0.5 after:bg-slate-900 after:absolute after:bottom-0 after:left-0 relative sm:transition-all hover:text-primary-blue-800 lg:text-lg'
