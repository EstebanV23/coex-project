...
export default function Profile () {
  ...
  return (
    <div className='flex gap-10 h-[20rem] items-stretch sm:p-0'>
      <div className={`${hiddenStyles} bg-primary-blue-600 p-3 rounded-lg transition-all z-0 flex flex-col items-center fixed gap-8 h-fit top-1/2 -translate-y-1/2 left-0 w-fit justify-center sm:static sm:left-auto sm:top-auto sm:translate-x-0 sm:translate-y-0 sm:py-8 sm:px-8 md:px-20 sm:rounded-none sm:h-full sm:justify-start`}>
        <h1 className='text-2xl text-white hidden font-semibold sm:block'>Hola <span className='font-bold'>{name}</span>!</h1>
