...
export default function ModalUser () {
  ...
  return (
    <div className={`text-xl font-medium absolute transition-all duration-500 ease-in-out left-0 top-0 w-full h-full grid text-center place-content-center text-white bg-slate-700 ${translate} lg:h-fit lg:left-auto lg:translate-x-full lg:px-6 lg:w-fit lg:py-6 lg:right-24 lg:left- lg:text-base lg:rounded-lg ${translateDesktop} lg:gap-3 lg:after:contents-[] lg:after:w-4 lg:after:h-4 lg:after:bg-slate-700 lg:after:absolute lg:after:-top-2 lg:after:left-1/2 lg:after:-translate-x-1/2 lg:after:rotate-45`}>
