  ...
  return (
    <div className='w-full'>
      <div className='flex h-14 flex-row-reverse overflow-clip rounded-lg'>
        <Field className='peer text-lg w-full rounded-r-lg border border-slate-400 px-2 text-slate-900 placeholder-slate-400 transition-colors duration-300 focus:border-primary-blue focus:outline-none' {...props} />
        <label
