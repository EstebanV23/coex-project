  ...
  return (
    <>
      ...
      {isLogged
        ...
        : <Button className='text-white bg-[#68A7AD] bg-opacity-0 px-5 w-fit self-center hover:text-[#68A7AD] hover:bg-white duration-500 ease-in hover:border-slate-300' onClick={() => openLoggin()}>Ingresar</Button>}
