  ...
  return (
    <>
      ...
      {isLogged
        ...
        : <Button textColor='text-white hover:text-primary-blue-500' bgColor='bg-primary-blue-500 hover:bg-white' className='px-5 w-fit self-center duration-500 ease-in hover:border-slate-300 ' onClick={() => openLoggin()}>Ingresar</Button>}
