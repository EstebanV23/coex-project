    ...
    <div className='flex flex-col items-center mt-10 justify-center w-full '>
      { usuarios && (
        ...
        className='text-xs'
          ...
          readOnly={ false }
        >
          <HotColumn data="nombre" title="Nombre" readOnly={ true } />
          <HotColumn data="peso" title="Peso" readOnly={ true } />
          <HotColumn data="talla" title="Talla" readOnly={ true } />
          <HotColumn data="sexo" title="Genero" readOnly={ true } />
          <HotColumn data="valoracion" title="Valoracion" readOnly={ true } />
        </HotTable>
      ) }
