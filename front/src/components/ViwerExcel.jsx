...
export default function ViwerExcel({ json }) {
  ...
  // me toco usar esa medidas porque la libreria no me deja trbajar con porcentajes para el scroll
  return (
    <div className='flex justify-center w-full h-full'>
      <div class="flex  flex-col sm:w-[600px] md:w-[600px] w-full items-center rounded-2xl bg-white py-5 px-2">
      <div class=" lg:h-[540px] md:w-[570px] w-full h-[600px] overflow-auto touch-auto ...">
        { json && (
          ...
          >
            ...
            <HotColumn data='peso' title='Peso'  />
            <HotColumn data='talla' title='Talla' />
            <HotColumn data='sexo' title='Genero' />
            <HotColumn data='valoracion' title='Valoracion' />
          </HotTable>
         
        ) }
        </div>
        <button onClick={ () => descargarArchivo() } className='w-fit px-6 bg-[#66a7ad] text-white h-10 rounded-md   hover:bg-[#3A676B mt-10'>Descargar Archivo</button>
      </div></div>
  )
}
